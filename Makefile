...
paavo: raylib
ifneq (,$(paavo_config))
	@echo "==== Building paavo ($(paavo_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f paavo.make config=$(paavo_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f paavo.make clean
